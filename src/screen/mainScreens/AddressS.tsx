...
const AddressS = observer(({navigation}: AddressSProps) => {
    ...
    const currentMapLocation = {latitude: location?.coordinates[1], longitude: location?.coordinates[0]}
    return (
        <>
            <BaseWrapperComponent isKeyboardAwareScrollView={true}>
                <Box paddingX={5} mt={2}>
                    ...
                    <Box flexDirection={'row'} mt={5} mb={10} justifyContent={'center'} alignItems={'center'}>
                        <Text fontSize={22} fontWeight={'bold'}>Address</Text>
                    </Box>

                    <Text fontSize={14} color={colors.gray} fontWeight={'500'}>Current address:</Text>
                    <Box mt={2} flexDirection={'row'} justifyContent={'space-between'} borderBottomWidth={1} pb={1}
                    ...
                    {
                        currentLocation?.fullAddress && <Box mt={5}>
                            <Box alignItems={'center'}>
                                <Text fontSize={22} color={colors.black} fontWeight={'500'}>New Address</Text>
                            </Box>
                            <Box>
                                ...
                                <Box mt={5}>
                                    <Button backgroundColor={colors.green} title={'Save new address'}
            ...
            {showLocationMap &&
                <MapViews from={'edit'} currentDataMap={{
                    location: currentMapLocation,
                    positionMarker: currentMapLocation,
                    address: {name: '11', formatted_address: formatted_address}
                }}
