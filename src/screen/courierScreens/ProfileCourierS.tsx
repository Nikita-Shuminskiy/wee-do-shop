		...
		<BaseWrapperComponent isKeyboardAwareScrollView={true}>
			<Box paddingX={5} mt={5} justifyContent={'space-between'} w={'100%'} flex={1}>
				<Box alignItems={'center'}>
					...
					<Text fontSize={28} mt={2} fontWeight={'700'}>
						Profile
					</Text>
				</Box>
				<Box w={'100%'} justifyContent={'flex-start'} mt={10} flex={1}>
					<Text color={colors.gray} fontSize={15} mb={2} fontWeight={'500'}>
						First name: <Text color={colors.black}>{user.firstName}</Text>{' '}
					</Text>
					<Text color={colors.gray} fontSize={15} mb={2} fontWeight={'500'}>
						Last name: <Text color={colors.black}>{user.lastName}</Text>
					</Text>
					<Text color={colors.gray} fontSize={15} fontWeight={'500'}>
						Phone: <Text color={colors.black}>{user.phone}</Text>
					</Text>
				</Box>
				<Box>
